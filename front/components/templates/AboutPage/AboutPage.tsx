        ...
        <div className={styles.about__inner}>
          <div className={`${styles.about__info} ${darkModeClass}`}>
            <p>
              ...
              деятельности. За время существования компании, мы в разы увеличили
            ...
            <p>
              Компания &quot;Ваша Мебель&quot; идет в ногу со временем. Наше
              предприятие регулярно использует свежие идеи из сферы мебельного
              производства, чтобы изготавливать не только качественные, но и
              стильные элементы интерьера. Мы рады предложить вам широкий спектр
              услуг по изготовлению диванов, кресел, пуфов и другой мягкой
              мебели по ценам от производителя.
            </p>
          </div>
